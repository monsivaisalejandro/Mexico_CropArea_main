...
def do_speckle_filtering(source):
    ...
    #parameters.put('filterSizeX', value)
    #parameters.put('filterSizeY', int(3))
...
def do_terrain_correction(source, proj, downsample):
    ...
    while downsample == 1:                      # downsample: 1 -- need downsample to 100m, 0 -- no need to downsample
        parameters.put('pixelSpacingInMeter', 100.0)
        break
...
def main():
    ...
    path = 'Sentinel1_images'
    outpath = 's1_processed'
